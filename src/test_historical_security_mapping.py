...
def main():
    ...
    assert historical_security_to_symbol("Vanguard Wellington Admiral") == "VWENX"

    assert historical_security_to_symbol("Vanguard Health Care-Admiral") == "VGHAX"

    # The Federal Money Market maps to VMFXX for historical pricing.
    assert (
        historical_security_to_symbol("Vanguard Federal Money Market Fund") == "VMFXX"
    )
